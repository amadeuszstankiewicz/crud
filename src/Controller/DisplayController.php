...
{
    /**
     * @Route("/users", name="display_users", methods={"GET"})
     */
    public function index(EntityManagerInterface $em): Response
    {
        ...
        return $this->render('display/index.html.twig', array('resultData' => $resultData));
    }

    /**
     * @Route("/user/create", name="display_user_create", methods={"GET", "POST"})
     */
    public function create(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('display/create.html.twig', array(
            'form' => $form->createView()
        ));
    }

    /**
     * @Route("/user/show/{id}", name="display_user_read", methods={"GET"})
     */
    public function read(int $id, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('display/read.html.twig', array('resultData' => $resultData));
    }

    /**
     * @Route("/user/update/{id}", name="display_user_update", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/user/delete/{id}", name="display_user_delete", methods={"DELETE"})
     */
